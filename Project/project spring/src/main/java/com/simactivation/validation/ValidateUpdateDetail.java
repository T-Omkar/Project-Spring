package com.simactivation.validation;
...
public class ValidateUpdateDetail {
	...
	@Pattern(regexp = "^[a-zA-Z0-9_ ]{1,25}$",message = "Address should be maximum of 25 characters")
	...
	public ValidateUpdateDetail(
			...
			@NotNull(message = "address can't be NULL") @Pattern(regexp = "^[a-zA-Z0-9_ ]{1,25}$", message = "Address should be maximum of 25 characters") String address,
